...
import SpatialSynthesizerSketch from '@/app/components/surreal-systems/SpatialSynthesizerSketch'
...
<HeroTitleBlock 
  title="Spatial Synthesizer 🎨🕹" 
  subtitle="Tweak the controls. Watch space vibrate." 
/>

<div className="w-full max-w-[320px] aspect-square mx-auto">
  <SpatialSynthesizerSketch width="100%" height="100%" />
</div>
