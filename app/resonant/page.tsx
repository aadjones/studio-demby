...
export default async function ResonantPage() {
  const all = await getAllProjects();
  const resonantProjects = all.filter((p) => p.cluster === "resonant");

  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-8">Resonant</h1>
      <p className="text-lg italic mb-6 text-zinc-600">Sound that remembers itself.</p>
